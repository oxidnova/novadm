...
// 	db, err := sqlxx.Connect(dbConf.Dsn, 3)
// 	if err != nil {
// 		return nil, fmt.Errorf("Couldn't connect db, dsn %s, %w", dbConf.Dsn, err)
// 	}
// 	db.SetMaxOpenConns(dbConf.MaxOpenConns)
...
// }
//
// func migrateUp(dbConf config.DB) error {
// 	// db migrate
// 	if err := sqlxx.CreateDBIfNotExist(dbConf.Dsn); err != nil {
// 		return fmt.Errorf("Couldn't create db, dsn %s, %w", dbConf.Dsn, err)
// 	}
//
// 	var dbOpts []sqlxx.DBSetupOpt
// 	if dbConf.MigrationPath != "" {
...
// 	}
//
// 	ndb, err := sqlxx.Connect(dbConf.Dsn, 3,
// 		sqlxx.SetDBSetupOpt(dbOpts...),
// 	)
// 	if err != nil {
// 		return fmt.Errorf("Couldn't connect db, dsn %s, %w", dbConf.Dsn, err)
// 	}
// 	ndb.Close()
//
// 	return nil
